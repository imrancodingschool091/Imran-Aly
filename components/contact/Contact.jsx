    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a href="mailto:imrancodingschool@gmail.com" className="contact__button">
            ...
            <div className="contact__card">
              ...
              <a href="https://api.whatsapp.com/send?phone=6209410566&text=Hello, I would like to connect with you!" className="contact__button">
                Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
        ...
        <div className="contact__content">
          ...
          >
            <input type="hidden" name="access_key" value="c612db70-ed0f-4703-b417-61aac622f0c1" />
